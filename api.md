...
- <code title="get /v1/datasets/{id}/csv">client.datasets.<a href="./src/patronus_api/resources/datasets.py">download_csv</a>(id) -> str</code>
- <code title="get /v1/datasets/{id}/jsonl">client.datasets.<a href="./src/patronus_api/resources/datasets.py">download_jsonl</a>(id) -> JSONLDecoder[DatasetDownloadJSONLResponse]</code>
