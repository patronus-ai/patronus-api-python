...
class TestPatronusAPI:
    ...
    def test_base_url_env(self) -> None:
        with update_env(PATRONUS_API_BASE_URL="http://localhost:5000/from/env"):
            client = PatronusAPI(api_key=api_key, access_token=access_token, _strict_response_validation=True)
...
class TestAsyncPatronusAPI:
    ...
    def test_base_url_env(self) -> None:
        with update_env(PATRONUS_API_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncPatronusAPI(api_key=api_key, access_token=access_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncPatronusAPI(
            base_url=base_url, api_key=api_key, access_token=access_token, _strict_response_validation=True
        )
