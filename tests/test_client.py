...
def _get_open_connections(client: PatronusAPI | AsyncPatronusAPI) -> int:
...
class TestPatronusAPI:
    client = PatronusAPI(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "patronus_api/_legacy_response.py",
                        "patronus_api/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "patronus_api/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: PatronusAPI) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(PATRONUS_API_BASE_URL="http://localhost:5000/from/env"):
            client = PatronusAPI(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: PatronusAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: PatronusAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: PatronusAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = PatronusAPI(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = PatronusAPI(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/v1/datasets").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.post(
                "/v1/datasets",
                body=cast(object, dict(dataset_name="x", file=b"raw file contents")),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/v1/datasets").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/v1/datasets").mock(side_effect=retry_handler)

        response = client.datasets.with_raw_response.create(dataset_name="x", file=b"raw file contents")
    ...
    def test_omit_retry_count_header(
        self, client: PatronusAPI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.datasets.with_raw_response.create(
            dataset_name="x", file=b"raw file contents", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.datasets.with_raw_response.create(
            dataset_name="x", file=b"raw file contents", extra_headers={"x-stainless-retry-count": "42"}
        )
...
class TestAsyncPatronusAPI:
    client = AsyncPatronusAPI(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncPatronusAPI) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(PATRONUS_API_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncPatronusAPI(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncPatronusAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncPatronusAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncPatronusAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncPatronusAPI(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncPatronusAPI(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.datasets.with_raw_response.create(dataset_name="x", file=b"raw file contents")
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncPatronusAPI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
