...
class TestMisc:
    ...
    def test_method_whoami(self, client: PatronusAPI) -> None:
        misc = client.misc.whoami()
        assert_matches_type(WhoAmIResponse, misc, path=["response"])

    @parametrize
    def test_raw_response_whoami(self, client: PatronusAPI) -> None:
        response = client.misc.with_raw_response.whoami()
    ...
    def test_streaming_response_whoami(self, client: PatronusAPI) -> None:
        with client.misc.with_streaming_response.whoami() as response:
...
class TestAsyncMisc:
    ...
    async def test_method_whoami(self, async_client: AsyncPatronusAPI) -> None:
        misc = await async_client.misc.whoami()
        assert_matches_type(WhoAmIResponse, misc, path=["response"])

    @parametrize
    async def test_raw_response_whoami(self, async_client: AsyncPatronusAPI) -> None:
        response = await async_client.misc.with_raw_response.whoami()
    ...
    async def test_streaming_response_whoami(self, async_client: AsyncPatronusAPI) -> None:
        async with async_client.misc.with_streaming_response.whoami() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
