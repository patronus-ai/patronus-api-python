...
from ...types import evaluator_criterion_list_params, evaluator_criterion_create_params
...
from .revision import (
    RevisionResource,
    AsyncRevisionResource,
    RevisionResourceWithRawResponse,
    AsyncRevisionResourceWithRawResponse,
    RevisionResourceWithStreamingResponse,
    AsyncRevisionResourceWithStreamingResponse,
)
...
from ...types.list_evaluator_criteria_response import ListEvaluatorCriteriaResponse
from ...types.create_evaluator_criteria_response import CreateEvaluatorCriteriaResponse
from ...types.archive_evaluator_criteria_response import ArchiveEvaluatorCriteriaResponse
...
class EvaluatorCriteriaResource(SyncAPIResource):
    @cached_property
    def revision(self) -> RevisionResource:
        return RevisionResource(self._client)
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=CreateEvaluatorCriteriaResponse,
        )
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=ListEvaluatorCriteriaResponse,
        )
    ...
    def archive(
        ...
        *,
        ...
        return self._patch(
            ...
            cast_to=ArchiveEvaluatorCriteriaResponse,
        )


class AsyncEvaluatorCriteriaResource(AsyncAPIResource):
    @cached_property
    def revision(self) -> AsyncRevisionResource:
        return AsyncRevisionResource(self._client)
...
class EvaluatorCriteriaResourceWithRawResponse:
    ...
    @cached_property
    def revision(self) -> RevisionResourceWithRawResponse:
        return RevisionResourceWithRawResponse(self._evaluator_criteria.revision)
...
class AsyncEvaluatorCriteriaResourceWithRawResponse:
    ...
    @cached_property
    def revision(self) -> AsyncRevisionResourceWithRawResponse:
        return AsyncRevisionResourceWithRawResponse(self._evaluator_criteria.revision)
...
class EvaluatorCriteriaResourceWithStreamingResponse:
    ...
    @cached_property
    def revision(self) -> RevisionResourceWithStreamingResponse:
        return RevisionResourceWithStreamingResponse(self._evaluator_criteria.revision)
...
class AsyncEvaluatorCriteriaResourceWithStreamingResponse:
    ...
    @cached_property
    def revision(self) -> AsyncRevisionResourceWithStreamingResponse:
        return AsyncRevisionResourceWithStreamingResponse(self._evaluator_criteria.revision)
