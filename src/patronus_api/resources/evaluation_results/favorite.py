...
class FavoriteResourceWithRawResponse:
    def __init__(self, favorite: FavoriteResource) -> None:
        ...
        self.mark = to_raw_response_wrapper(
            favorite.mark,
        )
        self.unmark = to_raw_response_wrapper(
            favorite.unmark,
        )
...
class AsyncFavoriteResourceWithRawResponse:
    def __init__(self, favorite: AsyncFavoriteResource) -> None:
        ...
        self.mark = async_to_raw_response_wrapper(
            favorite.mark,
        )
        self.unmark = async_to_raw_response_wrapper(
            favorite.unmark,
        )
...
class FavoriteResourceWithStreamingResponse:
    def __init__(self, favorite: FavoriteResource) -> None:
        ...
        self.mark = to_streamed_response_wrapper(
            favorite.mark,
        )
        self.unmark = to_streamed_response_wrapper(
            favorite.unmark,
        )
...
class AsyncFavoriteResourceWithStreamingResponse:
    def __init__(self, favorite: AsyncFavoriteResource) -> None:
        ...
        self.mark = async_to_streamed_response_wrapper(
            favorite.mark,
        )
        self.unmark = async_to_streamed_response_wrapper(
            favorite.unmark,
        )
