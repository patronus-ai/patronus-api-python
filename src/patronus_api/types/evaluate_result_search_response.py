...
__all__ = [
    ...
    "ResultAdditionalInfoConfidenceInterval",
    "ResultEvaluatedModelAttachment",
]


class ResultAdditionalInfoConfidenceInterval(BaseModel):
    alpha: float
...
class ResultAdditionalInfo(BaseModel):
    confidence_interval: Optional[ResultAdditionalInfoConfidenceInterval] = None
...
class ResultEvaluatedModelAttachment(BaseModel):
    media_type: str
...
class Result(BaseModel):
    ...
    additional_info: ResultAdditionalInfo
    ...
    evaluated_model_attachments: Optional[List[ResultEvaluatedModelAttachment]] = None
...
class EvaluateResultSearchResponse(BaseModel):
    results: List[Result]
