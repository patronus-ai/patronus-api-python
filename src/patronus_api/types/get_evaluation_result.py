...
__all__ = [
    "GetEvaluationResult",
    "EvaluationResult",
    "EvaluationResultAdditionalInfo",
    "EvaluationResultAdditionalInfoConfidenceInterval",
    "EvaluationResultEvaluatedModelAttachment",
]


class EvaluationResultAdditionalInfoConfidenceInterval(BaseModel):
    alpha: float
...
class EvaluationResultAdditionalInfo(BaseModel):
    confidence_interval: Optional[EvaluationResultAdditionalInfoConfidenceInterval] = None
...
class EvaluationResultEvaluatedModelAttachment(BaseModel):
    media_type: str
...
class EvaluationResult(BaseModel):
    ...
    evaluated_model_attachments: Optional[List[EvaluationResultEvaluatedModelAttachment]] = None
...
class GetEvaluationResult(BaseModel):
