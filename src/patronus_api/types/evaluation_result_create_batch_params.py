...
__all__ = ["EvaluationResultCreateBatchParams", "EvaluationResult", "EvaluationResultEvaluatedModelAttachment"]


class EvaluationResultCreateBatchParams(TypedDict, total=False):
