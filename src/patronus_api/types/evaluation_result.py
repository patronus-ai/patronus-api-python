...
__all__ = ["EvaluationResult", "AdditionalInfo", "AdditionalInfoConfidenceInterval", "EvaluatedModelAttachment"]


class AdditionalInfoConfidenceInterval(BaseModel):
    alpha: float
...
class EvaluatedModelAttachment(BaseModel):
    media_type: str
...
class EvaluationResult(BaseModel):
    ...
    explain_strategy: Optional[EvaluationExplainStrategies] = None
